...
const sendPushNotification = async (options: SendPushOptions) => {
  const { to, sound, title, body, data } = options;
...
const askForPushNotificationPermissions = async () => {
...
const registerForPushNotificationsAsync = async () => {
  await askForPushNotificationPermissions();
